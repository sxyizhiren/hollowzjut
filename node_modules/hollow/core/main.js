...
function buildPlugins(){
    ...
    foots={
        ...
        lengjing:{  //新增监听用户状态的功能
            exec:require('../lib/Foots/lengjingFoot').Foot,
            params:[]
        }
    };
    ...
    filters=[
        ...
        require('../lib/Filters/lengjingFilter').filter,//棱镜系统，监听人人用户的状态
