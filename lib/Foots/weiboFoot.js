...
var Login=require('./weiboLib/login');
...
var Foot=function(){
     ...
     * @param logininfo
     */
    var saveAccount=function(logininfo){
     ...
     * @param loginInfo
     */
    this.init=function(resv0,resv1){
    ...
    var visitPostList=function(){
        if(!isLogined || lock || !postList || postList.length ==0){
